...
/**
 * Система домов: Topocentric (Polich-Page).
 *
 * Примечание: временная реализация использует плацидус‑подобный численный подход к делению полу‑дуг
 * (как в Placidus) для формирования куспов. Это обеспечивает разумное поведение и гвард по широтам;
 * точная формула Topocentric будет доработана в последующих итерациях.
 */
final class Topocentric implements HouseSystem
{
    /**
     * Куспы Topocentric: временно численным решателем как в Placidus; гвард по широте.
